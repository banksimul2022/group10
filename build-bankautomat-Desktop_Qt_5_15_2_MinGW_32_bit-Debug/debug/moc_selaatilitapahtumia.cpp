...
#include <memory>
#include "../../bankautomat/selaatilitapahtumia.h"
...
QT_MOC_LITERAL(5, 102, 10) // "slotClient"

    },
    "selaatilitapahtumia\0"
    "on_btnPalaatilitapahtumat_clicked\0\0"
    "on_btnSeuraava_clicked\0on_btnEdellinen_clicked\0"
    "slotClient"
};
...
void selaatilitapahtumia::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->slotClient((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
